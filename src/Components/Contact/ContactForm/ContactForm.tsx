...
const ContactForm: React.FC = () => {
  const { formValues, formUpdateHandler, formSubmitHandler } = useContactForm();
  ...
  return (
    <form className="contact-form" onSubmit={(e) => formSubmitHandler(e)}>
      ...
      <div className="inputs-row sm:flex sm:justify-between" data-aos="fade-up">
        <div className="input-container relative inline-block">
          <input
            type="text"
            name="location"
      ...
      >
        <button
          className="capitalize font-bold pt-1 pb-2 px-3 sm:px-6 border-2 border-black hover:bg-black hover:text-white"
          type="submit"
        >
          Submit
        </button>
